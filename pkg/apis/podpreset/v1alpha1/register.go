...
// Package v1alpha1 contains API Schema definitions for the podpreset v1alpha1 API group
// +k8s:openapi-gen=true
// +k8s:deepcopy-gen=package,register
// +k8s:conversion-gen=github.com/jpeeler/podpresetbinding-crd/pkg/apis/podpreset
// +k8s:defaulter-gen=TypeMeta
// +groupName=podpreset.svcat.k8s.io
package v1alpha1
...
var (
	...
	SchemeGroupVersion = schema.GroupVersion{Group: "podpreset.svcat.k8s.io", Version: "v1alpha1"}

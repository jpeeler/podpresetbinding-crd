...
func TestReconcile(t *testing.T) {
	...
	instance := &podpresetv1alpha1.PodPresetBinding{ObjectMeta: metav1.ObjectMeta{Name: "foo", Namespace: "default"}}
	...
	// Create the PodPresetBinding object and expect the Reconcile and Deployment to be created
...
func DisabledTestReconcileWithBindingRef(t *testing.T) {
	...
	instance := &podpresetv1alpha1.PodPresetBinding{
		...
		Spec: podpresetv1alpha1.PodPresetBindingSpec{
			BindingRef: &v1.ObjectReference{Namespace: "default", Name: "test-binding"},
		},
	}
